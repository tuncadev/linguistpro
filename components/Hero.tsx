        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-8">
            <div className="inline-flex items-center gap-2 bg-[#f47361]/10 text-[#f47361] px-4 py-2 rounded-full text-sm font-semibold border border-[#f47361]/20">
              ...
              <EditableText translationKey="public.hero.badge" text={t('badge')} as="span" />
            </div>
            
            <h1 className="text-5xl lg:text-7xl font-black text-[#2d3e50] leading-[1.1] tracking-tight">
              <EditableText translationKey="public.hero.titleLine1" text={t('titleLine1')} as="span" /> <br />
              <span className="text-[#f47361] italic"><EditableText translationKey="public.hero.titleLine2" text={t('titleLine2')} as="span" /></span>
            </h1>
            
            <p className="text-xl text-slate-600 max-w-xl leading-relaxed">
              <EditableText translationKey="public.hero.description" text={t('description')} as="span" />
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <EditableText translationKey="public.hero.browseCourses" text={t('browseCourses')} as="span" /> <ArrowRight className="w-5 h-5" />
              </button>
              <button className="bg-white text-[#2d3e50] border-2 border-slate-200 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
                <PlayCircle className="w-5 h-5" /> <EditableText translationKey="public.hero.meetFaculty" text={t('meetFaculty')} as="span" />
              </button>
            </div>
              ...
              <div className="flex -space-x-3">
                {[
                  ...
                  <img 
                    ...
                    alt={`${t('studentAvatarAltPrefix')} ${i + 1}`} 
                  />
                ))}
              </div>
              <p className="text-sm font-medium text-slate-500">
                <EditableText translationKey="public.hero.joinLabel" text={t('joinLabel')} as="span" /> <span className="text-[#2d3e50] font-bold">12,000+</span> <EditableText translationKey="public.hero.joinSuffix" text={t('joinSuffix')} as="span" />
              </p>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative glass p-4 rounded-3xl border border-white/50 shadow-2xl">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-4 max-w-[240px]">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-wider"><EditableText translationKey="public.hero.accredited" text={t('accredited')} as="span" /></p>
                  <p className="text-sm font-bold text-[#2d3e50]"><EditableText translationKey="public.hero.accreditedSub" text={t('accreditedSub')} as="span" /></p>
                </div>
              </div>
            </div>
          </div>
